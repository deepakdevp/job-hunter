"""Greenhouse ATS form filler strategy."""
...
class GreenhouseFormFiller(BaseFormFiller):
    ...
    SUBMIT_BUTTON: str = "#submit_app"

    async def detect(self, page: Page) -> bool:
        """Return *True* if the page URL contains greenhouse.io."""
        return "greenhouse.io" in page.url

    async def fill(self, page: Page, job: Job, profile: dict) -> FillResult:
        """Fill the Greenhouse application form fields."""
        filled = 0
        skipped = 0
