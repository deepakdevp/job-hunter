"""Lever ATS form filler strategy."""
...
class LeverFormFiller(BaseFormFiller):
    ...
    SUBMIT_BUTTON: str = ".postings-btn-submit"

    async def detect(self, page: Page) -> bool:
        """Return *True* if the page URL contains lever.co."""
        return "lever.co" in page.url

    async def fill(self, page: Page, job: Job, profile: dict) -> FillResult:
        """Fill the Lever application form fields."""
        filled = 0
        skipped = 0
